...
$$
\tag{1}
\hat{\log(\text{compensation}_i)} = \beta_0 + \beta_{1} \times \text{age}_i + \beta_2 \times \text{male}_i + \beta_3 \times \text{SectorServices}_i + \beta_4 \times \text{SectorBasicMaterials}_i + \epsilon_i
$$
...
# Summary
summary(m1ppc)
p <- plot(m1ppc %>% get_value("ppc"), "normality") ; plot(p) # Two-sided test ==> violation 
