...
Much of the differences between Frequentist and Bayesian inference stems epistemological differences in their views of probability. In the Frequentist framework, probabilities are looked upon as the limiting value of the number of $k$ successes in a sequence of $n$ trials [CITE/CHANGE/DIRECT QUOTE FROM STACKEX], or:
