...
For a large part, differences between Frequentist and Bayesian inference stems from their respective view of uncertainty and how this is captured in the probability framework. In the Frequentist framework, probabilities are looked upon as the limiting value of the number of $k$ successes in a sequence of $n$ trials [CITE/CHANGE/DIRECT QUOTE FROM STACKEX], or:
...
$$
\text{H}_a\text{: } \beta_{\text{Male}} \approx 0
$$

$$
\text{H}_u\text{: } \beta_\text{Male} \text{ not H}_a
$$
