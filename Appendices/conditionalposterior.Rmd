...
posterior_coef <- function(X, y, w, j, priors, sigma) {
  ...
  # Calculate mu
  mu1 <- posterior_mu(X, xj, y, w, sigma, priors$mu, priors$sd)
...
```{r}
# Starting values
sigma <- rgamma(1, 0.001, 0.001) + 1e-10#0.1
...
# Priors
priors <- list(
  "b0" = list("mu"=0, "sd"=1000),
  "b1" = list("mu"=0, "sd"=1000),
  "b2" = list("mu"=0, "sd"=1000),
  "b3" = list("mu"=0, "sd"=1000),
  "b4" = list("mu"=0, "sd"=1000),
  "b5" = list("mu"=0, "sd"=1000),
